...
<head>
	...
	<meta name="author" content="Fernando Sanchiz">
	...
	<script src="<?php echo base_url() ?>js/fileinput/plugins/canvas-to-blob.js"></script>
	<script src="<?php echo base_url() ?>js/fileinput/fileinput.js" type="text/javascript"></script>
